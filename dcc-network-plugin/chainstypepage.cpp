...
ChainsTypePage::ChainsTypePage(QWidget *parent)
    : ContentWidget(parent)
{
    setTitle(tr("Proxy Type"));

    TranslucentFrame *contentFrame = new TranslucentFrame(this);
    OptionItem* http = new OptionItem(contentFrame);
    http->setTitle("http");
    http->setContentsMargins(20, 0, 10, 0);

    OptionItem* socks4 = new OptionItem(contentFrame);
    socks4->setTitle("socks4");
    socks4->setContentsMargins(20, 0, 10, 0);

    OptionItem* socks5 = new OptionItem(contentFrame);
