...
> ![attention](icon/attention.svg): If there is no update for system, it will show "Click to check update"; some functions will take effect by rebooting after upgraded the system and applications.
