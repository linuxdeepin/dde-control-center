...
<context>
    ...
    <message>
        ...
        <translation>開啟用戶體驗計劃視為您授權我們收集和使用您的裝置及系統訊息，以及應用軟體訊息，您可以關閉使用者體驗計劃以拒絕我們對前述訊息的收集和使用。詳細說明請參照統信軟體隱私政策(https://www.uniontech.com/agreement/privacy-cn)。</translation>
    </message>
</context>
<context>
