...
<context>
    ...
    <message>
        ...
        <translation>用戶體驗計劃通過收集和分析設備及系統訊息、應用軟件訊息、系統運行異常訊息，來提升產品和服務質量。開啟用戶體驗計劃視為您授權我們收集和使用您的前述訊息。您可以關閉用戶體驗計劃以拒絕我們對前述訊息的收集和使用。了解數據的管理方式，參照私隱政策：https://www.uniontech.com/agreement/deepin-privacy-cn。</translation>
    </message>
    <message>
