...
<context>
    ...
    <message>
        ...
        <translation>用户体验计划通过收集和分析设备及系统信息、应用软件信息、系统运行异常信息，来提升产品和服务质量。开启用户体验计划视为您授权我们收集和使用您的前述信息。您可以关闭用户体验计划以拒绝我们对前述信息的收集和使用。了解数据的管理方式，参照隐私政策：https://www.uniontech.com/agreement/deepin-privacy-cn。</translation>
    </message>
    <message>
