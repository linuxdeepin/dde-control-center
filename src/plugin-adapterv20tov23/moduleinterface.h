...
public:
    ...
    virtual void
    preInitialize(bool sync = false,
                  FrameProxyInterface::PushType = FrameProxyInterface::PushType::Normal)
    {
        Q_UNUSED(sync)
    }
    ...
    /// \return
    ///
    virtual QIcon icon() const { return QIcon::fromTheme(QString("dcc_nav_%1").arg(name())); }
...
public:
    ...
    inline bool deviceUnavailabel() const { return m_deviceUnavailabel; }
