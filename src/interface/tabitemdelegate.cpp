...
void TabItemDelegate::paint(QPainter *painter,
...
void TabItemDelegate::drawBackground(const QStyle *style,
                                     QPainter *painter,
...
void TabItemDelegate::drawDecoration(QPainter *painter,
                                     const QStyleOptionViewItem &option,
...
void TabItemDelegate::drawDisplay(const QStyle *style,
                                  QPainter *painter,
                                  const QStyleOptionViewItem &option,
                                  const QRect &rect) const
{
...
void TabItemDelegate::drawEllipse(QPainter *painter,
                                  const QStyleOptionViewItem &option,
...
void TabItemDelegate::drawFocus(const QStyle *style,
                                QPainter *painter,
                                const QStyleOptionViewItem &option,
                                const QRect &rect) const
{
