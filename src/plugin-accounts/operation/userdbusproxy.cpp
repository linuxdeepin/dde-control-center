...
void UserDBusProxy::init()
{
    ...
    m_dBusAccountsUserInter = new QDBusInterface(AccountsUserService,
                                                 m_accountsUserPath,
...
QDBusPendingReply<> UserDBusProxy::AddGroup(const QString &group)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("AddGroup"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::DeleteGroup(const QString &group)
{
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(group);
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("DeleteGroup"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::DeleteIconFile(const QString &iconFile)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("DeleteIconFile"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::EnableNoPasswdLogin(bool enabled)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("EnableNoPasswdLogin"),
                                                              argumentList);
}
...
{
    QList<QVariant> argumentList;
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("IsPasswordExpired"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetAutomaticLogin(bool enabled)
{
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(enabled);
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("SetAutomaticLogin"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetDesktopBackgrounds(const QStringList &backgrounds)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(
            QStringLiteral("SetDesktopBackgrounds"),
            argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetFullName(const QString &name)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("SetFullName"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetGreeterBackground(const QString &background)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(
            QStringLiteral("SetGreeterBackground"),
            argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetGroups(const QStringList &groups)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("SetGroups"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetHistoryLayout(const QStringList &layouts)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("SetHistoryLayout"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetHomeDir(const QString &home)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("SetHomeDir"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetIconFile(const QString &iconFile)
{
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(iconFile);
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("SetIconFile"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetLayout(const QString &layout)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("SetLayout"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetLocale(const QString &locale)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("SetLocale"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetLocked(bool locked)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("SetLocked"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetMaxPasswordAge(int nDays)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("SetMaxPasswordAge"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetPassword(const QString &password)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("SetPassword"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetPasswordHint(const QString &hint)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("SetPasswordHint"),
                                                              argumentList);
}
...
QDBusPendingReply<> UserDBusProxy::SetShell(const QString &shell)
{
    ...
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("SetShell"),
                                                              argumentList);
}
...
QDBusPendingReply<>
UserDBusProxy::SetSecretQuestions(const QMap<int, QByteArray> &securityQuestions)
{
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(securityQuestions);
    return m_dBusAccountsUserInter->asyncCallWithArgumentList(QStringLiteral("SetSecretQuestions"),
                                                              argumentList);
}
