...
void NativeInfoWidget::initWidget()
{
    ...
    QWidget *container = new QFrame(this);
    ...
    if (DSysInfo::uosType() == DSysInfo::UosType::UosServer ||
        ...
        //点击编辑按钮
        QObject::connect(m_hostNameBtn, &DToolButton::clicked, this, &NativeInfoWidget::onToolButtonButtonClicked);

        QObject::connect(m_hostNameLineEdit, &DLineEdit::focusChanged, this, &NativeInfoWidget::onFocusChanged);
        QObject::connect(m_hostNameLineEdit, &DLineEdit::textEdited, this, &NativeInfoWidget::onTextEdited);
        QObject::connect(m_hostNameLineEdit, &DLineEdit::alertChanged, this, &NativeInfoWidget::onAlertChanged);
        QObject::connect(m_hostNameLineEdit->lineEdit(), &QLineEdit::editingFinished, this, &NativeInfoWidget::onEditingFinished);
        QObject::connect(m_model, &SystemInfoModel::hostNameChanged, this, &NativeInfoWidget::onHostNameChanged);
        QObject::connect(m_model, &SystemInfoModel::setHostNameError, this, &NativeInfoWidget::onSetHostNameError);
...
//    GSettingWatcher::instance()->bind("systeminfoNativeinfoMemory", m_memory);
    ...
    QObject::connect(m_model, &SystemInfoModel::productNameChanged, this, &NativeInfoWidget::setProductName);
    QObject::connect(m_model, &SystemInfoModel::versionNumberChanged, this, &NativeInfoWidget::setVersionNumber);
    QObject::connect(m_model, &SystemInfoModel::versionChanged, this, &NativeInfoWidget::setEdition);
    QObject::connect(m_model, &SystemInfoModel::typeChanged, this, &NativeInfoWidget::setType);
    QObject::connect(m_model, &SystemInfoModel::processorChanged, this, &NativeInfoWidget::setProcessor);
    QObject::connect(m_model, &SystemInfoModel::memoryChanged, this, &NativeInfoWidget::setMemory);

    //传递button的点击信号
    QObject::connect(m_authorized, &TitleAuthorizedItem::clicked, this, &NativeInfoWidget::clickedActivator);
    QObject::connect(m_model, &SystemInfoModel::licenseStateChanged, this, &NativeInfoWidget::setLicenseState);
...
const QString NativeInfoWidget::systemCopyright() const
{
    ...
    if (oem_copyright.isEmpty()) {
        if (DSysInfo::isCommunityEdition())
            return QApplication::translate("dccV23::SystemInfoWidget", "Copyright© 2011-%1 Deepin Community").arg(2022);
        else
            return QApplication::translate("dccV23::SystemInfoWidget", "Copyright© 2019-%1 UnionTech Software Technology Co., LTD").arg(2022);
    } else {
