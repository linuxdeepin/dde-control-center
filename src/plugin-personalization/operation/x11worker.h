...
public Q_SLOTS:
    ...
    virtual void setWallpaperForMonitor(const QString &screen, const QString &url, PersonalizationExport::WallpaperSetOption option, PersonalizationExport::WallpaperSetType type = PersonalizationExport::Type_Image) override;
    void setBackgroundForMonitor(const QString &screenName, const QString &url, PersonalizationExport::WallpaperSetType type = PersonalizationExport::Type_Image) override;
    void setLockBackForMonitor(const QString &screenName, const QString &url, PersonalizationExport::WallpaperSetType type = PersonalizationExport::Type_Image) override;
