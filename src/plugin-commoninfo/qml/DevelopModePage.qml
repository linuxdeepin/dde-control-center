...
DccObject {
    ...
    DccObject {
        ...
        DccObject {
            ...
            pageType: DccObject.Item
            page: Label {
                property string textColor: D.DTK.themeType === D.ApplicationHelper.LightType ?
                ...
                text: "<span style=\"color: " + textColor + ";\">" + qsTr("To install and run unsigned apps, please go to ") + "</span><a href=\"Security Center\" style=\"color: rgba(0, 88, 222, 1); text-decoration: none;\">" + qsTr("Security Center") + "</a><span style=\"color: " + textColor + ";\">" + qsTr(" to change the settings.") + "</span>"
                font: D.DTK.fontManager.t10
                // 超链接点击事件
                onLinkActivated: function(url) {
                    console.log("点击的链接是: " + url)
