...
#include "src/systeminfo/operation/systeminfowork.h"
...
QWidget *NativeInfoModule::page() const
{
...
QWidget *PrivacyPolicyModule::page() const
{
    return new PrivacyPolicyWidget();
}

QWidget *UserLicenseModule::page() const
{
    return new UserLicenseWidget();
}

QWidget *VersionProtocolModule::page() const
{
