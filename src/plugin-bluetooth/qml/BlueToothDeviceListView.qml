                        ...
                        RowLayout {
                            ...
                            Loader {
                                ...
                                sourceComponent: D.ActionButton {
                                    ...
                                    D.Menu {
                                        Accessible.id: "ContextMenu_5"
                                        id: contextMenu
                                        implicitWidth: 150

                                        D.MenuItem {
                                            Accessible.id: "ConnectDev"
                                            id: connectDev
                                            padding: 0
                                            text: model.connectStatus === 2 ? qsTr("Disconnect") : qsTr("Connect")
                                            enabled: model.connectStatus === 2 || model.connectStatus === 0
