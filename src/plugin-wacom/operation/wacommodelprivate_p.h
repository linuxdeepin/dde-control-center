...
protected:
    ...
    void initConnect()
    {
        QObject::connect(m_wacomInterfaceProxy,
                         &WacomDBusProxy::ExistChanged,
                         q_ptr,
        ...
        QObject::connect(m_wacomInterfaceProxy,
                         &WacomDBusProxy::CursorModeChanged,
                         q_ptr,
                         [this](bool value) -> void {
        ...
        QObject::connect(m_wacomInterfaceProxy,
                         &WacomDBusProxy::EraserPressureSensitiveChanged,
                         q_ptr,
                         [this](uint value) -> void {
