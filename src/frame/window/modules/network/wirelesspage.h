...
public Q_SLOTS:
    /**
     * @brief onDeviceRemoved
     * @param device
     * @remark 删除wifi适配器
     */
    void onDeviceRemoved(dde::network::NetworkDevice *device);
    /**
     * @brief onApWidgetEdit
     * @param apPath
     * @param uuid
     * @remark 调用wifi编辑页
     */
    void onApWidgetEdit(const QString &apPath, const QString &uuid);
    /**
     * @brief onApConnect
     * @param apPath
     * @param uuid
    ...
    /**
     * @brief onHideApConnect
     * @param apPath
     * @param ssid
     * @remark 请求连接隐藏wifi
     */
    void onHideApConnect(const QString &apPath, const QString &uuid);
    /**
     * @brief onUpdateApList
     * @remark 请求刷新wifi列表
     */
    void onUpdateApList();
    /**
...
private:
        /**
         * @brief sortApList
         * @remark 对wifi进行排序，目前是按照信号强度进行排序
         */
        void sortApList();
        /**
         * @def ApLoadin
