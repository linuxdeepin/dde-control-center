        ...
        ObjectModel {
            ...
            ColumnLayout {
                ...
                Label {
                    ...
                    text: dccData.irisController.addStage === CharaMangerModel.Success ? qsTr("Face enrolled") : qsTr("Failed to enroll your face")
                }
...
3. Please avoid tilting or lowering your head, closing your eyes or showing only one side of your face, and make sure your front face appears clearly and completely in the prompt box.`)
        ...
        Connections {
            ...
            function onAddStageChanged() {
                console.warn("===onAddStageChanged===", dccData.irisController.addStage)
