...
{
    m_dBusNotificationPropertiesInter = new QDBusInterface(NotificationService,
                                                           NotificationPath,
                                                           PropertiesInterface,
                                                           QDBusConnection::sessionBus(),
                                                           this);
    m_dBusNotificationInter = new QDBusInterface(NotificationService,
                                                 NotificationPath,
    ...
    dbusConnection.connect(NotificationService,
                           NotificationPath,
                           PropertiesInterface,
                           PropertiesChanged,
                           this,
    ...
    dbusConnection.connect(NotificationService,
                           ...
                           "AppAddedSignal",
                           this,
                           SIGNAL(AppAddedSignal(QString)));
    dbusConnection.connect(NotificationService,
                           NotificationPath,
                           NotificationInterface,
                           "AppInfoChanged",
                           this,
                           SIGNAL(AppInfoChanged(QString, uint, QDBusVariant)));
    dbusConnection.connect(NotificationService,
                           NotificationPath,
                           NotificationInterface,
                           "AppRemovedSignal",
                           this,
                           SIGNAL(AppRemovedSignal(QString)));
    dbusConnection.connect(NotificationService,
                           NotificationPath,
                           NotificationInterface,
                           "NotificationClosed",
    ...
    dbusConnection.connect(NotificationService,
                           ...
                           "RecordAdded",
                           this,
                           SIGNAL(RecordAdded(QString)));
    dbusConnection.connect(NotificationService,
                           NotificationPath,
                           NotificationInterface,
                           "SystemInfoChanged",
                           this,
                           SIGNAL(SystemInfoChanged(uint, QDBusVariant)));
    dbusConnection.connect(NotificationService,
                           NotificationPath,
                           NotificationInterface,
                           "appAdded",
                           this,
                           SIGNAL(appAdded(QString)));
    dbusConnection.connect(NotificationService,
                           NotificationPath,
                           NotificationInterface,
                           "appRemoved",
                           this,
                           SIGNAL(appRemoved(QString)));
    dbusConnection.connect(NotificationService,
                           NotificationPath,
                           NotificationInterface,
                           "appSettingChanged",
                           this,
                           SIGNAL(appSettingChanged(QString)));
    dbusConnection.connect(NotificationService,
                           NotificationPath,
                           NotificationInterface,
                           "systemSettingChanged",
                           this,
                           SIGNAL(systemSettingChanged(QString)));
}
...
QDBusPendingReply<> NotificationDBusProxy::ClearRecords()
{
    ...
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("ClearRecords"),
                                                              argumentList);
}
...
QDBusPendingReply<> NotificationDBusProxy::CloseNotification(uint in0)
{
    ...
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("CloseNotification"),
                                                              argumentList);
}
...
{
    QList<QVariant> argumentList;
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("GetAllRecords"),
                                                              argumentList);
}
...
QDBusPendingReply<QDBusVariant> NotificationDBusProxy::GetAppInfo(const QString &in0, uint in1)
{
    ...
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("GetAppInfo"),
                                                              argumentList);
}
...
{
    QList<QVariant> argumentList;
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("GetAppList"),
                                                              argumentList);
}
...
{
    QList<QVariant> argumentList;
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("GetCapbilities"),
                                                              argumentList);
}
...
QDBusPendingReply<QString> NotificationDBusProxy::GetRecordById(const QString &in0)
{
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(in0);
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("GetRecordById"),
                                                              argumentList);
}
...
QDBusPendingReply<QString> NotificationDBusProxy::GetRecordsFromId(int in0, const QString &in1)
{
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(in0) << QVariant::fromValue(in1);
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("GetRecordsFromId"),
                                                              argumentList);
}
...
{
    QList<QVariant> argumentList;
    return m_dBusNotificationInter->asyncCallWithArgumentList(
            QStringLiteral("GetServerInformation"),
            argumentList);
}

QDBusReply<QString> NotificationDBusProxy::GetServerInformation(QString &out1,
                                                                QString &out2,
                                                                QString &out3)
{
    QList<QVariant> argumentList;
    QDBusMessage reply =
            m_dBusNotificationInter->callWithArgumentList(QDBus::Block,
                                                          QStringLiteral("GetServerInformation"),
                                                          argumentList);
...
QDBusPendingReply<QDBusVariant> NotificationDBusProxy::GetSystemInfo(uint in0)
{
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(in0);
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("GetSystemInfo"),
                                                              argumentList);
}
...
QDBusPendingReply<uint> NotificationDBusProxy::Notify(const QString &in0,
                                                      uint in1,
                                                      const QString &in2,
                                                      const QString &in3,
                                                      const QString &in4,
                                                      ...
                                                      int in7)
{
    ...
    argumentList << QVariant::fromValue(in0) << QVariant::fromValue(in1) << QVariant::fromValue(in2)
                 << QVariant::fromValue(in3) << QVariant::fromValue(in4) << QVariant::fromValue(in5)
                 << QVariant::fromValue(in6) << QVariant::fromValue(in7);
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("Notify"),
                                                              argumentList);
}
...
QDBusPendingReply<> NotificationDBusProxy::RemoveRecord(const QString &in0)
{
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(in0);
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("RemoveRecord"),
                                                              argumentList);
}

QDBusPendingReply<> NotificationDBusProxy::SetAppInfo(const QString &in0,
                                                      uint in1,
                                                      const QDBusVariant &in2)
{
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(in0) << QVariant::fromValue(in1)
                 << QVariant::fromValue(in2);
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("SetAppInfo"),
                                                              argumentList);
}
...
QDBusPendingReply<> NotificationDBusProxy::SetSystemInfo(uint in0, const QDBusVariant &in1)
{
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(in0) << QVariant::fromValue(in1);
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("SetSystemInfo"),
                                                              argumentList);
}
...
{
    QList<QVariant> argumentList;
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("Toggle"),
                                                              argumentList);
}
...
QDBusPendingReply<QString> NotificationDBusProxy::getAppSetting(const QString &in0)
{
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(in0);
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("getAppSetting"),
                                                              argumentList);
}
...
{
    QList<QVariant> argumentList;
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("recordCount"),
                                                              argumentList);
}
...
QDBusPendingReply<> NotificationDBusProxy::setAppSetting(const QString &in0)
{
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(in0);
    return m_dBusNotificationInter->asyncCallWithArgumentList(QStringLiteral("setAppSetting"),
                                                              argumentList);
}
