...
echo " =================== get info end ==================== "
echo " =================== do filter begin ==================== "
lcov --remove ./coverage.info  '*/${MOUSE_NAME}_autogen/*' '*/${NOTIFICATION_NAME}_autogen/*' '*/${DEFAPP_NAME}_autogen/*' '*/${SYSTEMINFO_NAME}_autogen/*' '*/${KEYBOARD_NAME}_autogen/*' '*/usr/include/*' '*/tests/*' '*/googletest/*' '*/widgets/*' '*/interface/*' -o ./coverage.info
echo " =================== do filter end ==================== "
