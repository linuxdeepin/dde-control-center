    ...
    GridView {
        ...
        delegate: Rectangle {
            ...
            Rectangle {
                ...
                width: 12
                height: 12
                color: root.colors[Math.floor(index / 19)][index % 19]
                anchors.centerIn: parent
