...
#ifndef DBUSAUDIOSINK_H_1437014937
#define DBUSAUDIOSINK_H_1437014937
...
struct SinkPortStruct {
    QString id;
    QString name;
    uchar index;
};

typedef QList<SinkPortStruct> SinkPortList;

Q_DECLARE_METATYPE(SinkPortList)
Q_DECLARE_METATYPE(SinkPortStruct)
 ...
 */
class DBusAudioSink: public QDBusAbstractInterface
{
    Q_OBJECT
...
public:
    DBusAudioSink(const QString &path, QObject *parent = 0);

    ~DBusAudioSink();

    Q_PROPERTY(SinkPortStruct ActivePort READ activePort NOTIFY ActivePortChanged)
    inline SinkPortStruct activePort() const
    { return qvariant_cast< SinkPortStruct >(property("ActivePort")); }
    ...
    Q_PROPERTY(SinkPortList Ports READ ports NOTIFY PortsChanged)
    inline SinkPortList ports() const
    { return qvariant_cast< SinkPortList >(property("Ports")); }
