...
typedef QString SinkPortsStruct;//invalid data
Q_DECLARE_METATYPE(SinkPortsStruct)
/*
...
public:
    ...
    Q_PROPERTY(SinkPortsStruct ActivePort READ activePort NOTIFY ActivePortChanged)
    inline SinkPortsStruct activePort() const
    { return qvariant_cast< SinkPortsStruct >(property("ActivePort")); }
    ...
    Q_PROPERTY(SinkPortsStruct Ports READ ports NOTIFY PortsChanged)
    inline SinkPortsStruct ports() const
    { return qvariant_cast< SinkPortsStruct >(property("Ports")); }
