...
#include "dbusaudiosinkinput.h"

/*
 * Implementation of interface class DBusAudioSinkInput
 */

DBusAudioSinkInput::DBusAudioSinkInput(const QString &path, QObject *parent)
...
DBusAudioSinkInput::~DBusAudioSinkInput()
{
